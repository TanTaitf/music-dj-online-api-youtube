...
public class Adapter_Tab_2 extends RecyclerView.Adapter<Adapter_Tab_2.ViewHolder>{
    private ArrayList<Video> truyenTranhArrayList;
    private Context context;
    private int preViousPositon=0;
    private Typeface typeFace;
    public Adapter_Tab_2(ArrayList<Video> truyenTranhArrayList, Context context) {
    ...
    @Override
    public Adapter_Tab_2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adapter_Tab_2.ViewHolder holder, int position) {
