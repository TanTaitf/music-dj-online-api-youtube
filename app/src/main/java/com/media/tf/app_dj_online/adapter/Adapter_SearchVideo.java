...
public class Adapter_SearchVideo extends RecyclerView.Adapter<Adapter_SearchVideo.ViewHolder> {
    ...
    public Adapter_SearchVideo(ArrayList<Video> truyenTranhArrayList, Context context) {
    ...
    @Override
    public Adapter_SearchVideo.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Adapter_SearchVideo.ViewHolder holder, int position) {
