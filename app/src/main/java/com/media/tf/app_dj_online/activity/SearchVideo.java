...
//    int count = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterSearch = new Adapter_ViewSearch(arraySearch, SearchVideo.this);
        avi.show();
        ...
        txtTitle.setText(key_Search.toUpperCase());
    ...
    private void setTruyenTranh(final RecyclerView mRecyclerView , String key, final boolean action, boolean layout) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                adapter = new Adapter_SearchVideo(arrayList,SearchVideo.this);
